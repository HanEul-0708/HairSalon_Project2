...
-- 1) 프로젝트 전용 사용자 계정 생성
CREATE
 USER IF NOT EXISTS 'salon_user'@'localhost' IDENTIFIED BY '1234';

-- 2) 프로젝트 DB 전체 권한 부여
GRANT ALL PRIVILEGES ON salon_project_v2.* TO
 'salon_user'@'localhost';
...
-- 4) 권한 확인 (선택)
SHOW
 GRANTS FOR 'salon_user'@'localhost';
...
-- =========================================================
DROP
 DATABASE IF EXISTS salon_project_v2;

CREATE
 DATABASE salon_project_v2
