...
function bindDesignerRegionFilters() {
    ...
    var regions = parseDesignerRegions(addresses);
...
function parseDesignerRegions(addresses) {
    var citySet = new Set();
    var districtsByCity = {};
    ...
    return {
        ...
        districtsByCity: sortDesignerRegionMap(districtsByCity),
        neighborhoodsByDistrict: sortDesignerRegionMap(neighborhoodsByDistrict)
    };
}
...
function sortDesignerRegionMap(source) {
    var result = {};
