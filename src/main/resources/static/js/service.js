...
function bindServiceRegionFilters() {
    ...
    var regions = parseServiceRegions(addresses);
...
function parseServiceRegions(addresses) {
    var citySet = new Set();
    var districtsByCity = {};
    ...
    return {
        ...
        districtsByCity: sortServiceRegionMap(districtsByCity),
        neighborhoodsByDistrict: sortServiceRegionMap(neighborhoodsByDistrict)
    };
}
...
function sortServiceRegionMap(source) {
    var result = {};
