...
import com.hairsalonproject2.dto.response.*;

import com.hairsalonproject2.entity.Salon;
import com.hairsalonproject2.entity.SalonLike;

import com.hairsalonproject2.repository.DesignerRepository;
import com.hairsalonproject2.repository.SalonLikeRepository;
import com.hairsalonproject2.repository.SalonRepository;
import com.hairsalonproject2.repository.SalonServiceRepository;

import com.hairsalonproject2.support.GeoUtils;
...
public class SalonQueryService {
    ...
    public List<SalonSummaryResponse> search(SalonSearchRequest request) {
        ...
        if ("distance".equalsIgnoreCase(request.getSort())) {
            ...
            responses.sort(Comparator.comparing(SalonSummaryResponse::getAverageRating, Comparator.nullsLast(Comparator.reverseOrder()))
                    .thenComparing(SalonSummaryResponse::getReviewCount, Comparator.nullsLast(Comparator.reverseOrder())));
            ...
            responses.sort(Comparator.comparing(SalonSummaryResponse::getAverageRating, Comparator.nullsLast(Comparator.reverseOrder()))
                    .thenComparing(SalonSummaryResponse::getReviewCount, Comparator.nullsLast(Comparator.reverseOrder()))
                    .thenComparing(SalonSummaryResponse::getLikeCount, Comparator.nullsLast(Comparator.reverseOrder())));
        }
        return responses;
    }
    ...
    public SalonDetailResponse getDetail(Integer salonId) {
        ...
        Map<Integer, com.hairsalonproject2.service.projection.DesignerRatingRow> ratings = designerRepository.findDesignerRatingRows().stream()
                .collect(Collectors.toMap(com.hairsalonproject2.service.projection.DesignerRatingRow::getDesignerId, Function.identity()));
    ...
    public boolean unlike(Integer salonId, String memberId) {
        Salon salon = salonRepository.findById(salonId)
                .orElseThrow(() -> new EntityNotFoundException("Salon not found: " + salonId));
        return salonLikeRepository.findByMemberIdAndSalonSalonId(memberId, salonId)
                .map(like -> {
