...
public class FileUploadService {
  ...
  * 필요한 것만 열어 둔다.
  */
 private static final Set<String> ALLOWED_FILE_EXTENSIONS = Set.of("pdf", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "hwp", "hwpx", "txt", "zip", "jpg", "jpeg", "png");
 ...
 public FileResponse uploadEditorImage(MultipartFile file) throws IOException {
  ...
  return FileResponse.builder().url("/files/images/" + uploadFile.getStoredFilename()).originalFilename(uploadFile.getOriginalFilename()).build();
 }
