...
public class GlobalPageExceptionHandler {
 ...
 public String handleBoardException(BoardException e, HttpServletRequest request, Model model) {
 ...
 public String handleAccessDeniedException(Exception e, HttpServletRequest request, HttpServletResponse response, Model model) {
 ...
 public String handleNoResourceFoundException(NoResourceFoundException e, HttpServletRequest request, HttpServletResponse response, Model model) {
  return renderNotFound(request, response, model);
 }

 @ExceptionHandler(NoHandlerFoundException.class)
 public String handleNoHandlerFoundException(NoHandlerFoundException e, HttpServletRequest request, HttpServletResponse response, Model model) {
  return renderNotFound(request, response, model);
 }

 private String renderNotFound(HttpServletRequest request, HttpServletResponse response, Model model) {
