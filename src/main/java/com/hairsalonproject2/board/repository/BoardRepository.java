...
public interface BoardRepository extends JpaRepository<Board, Integer> {
 ...
 @Query(value = """
		 ...
		 """)
 Page<BoardResponse> searchPageByTypeAndKeyword(@Param("type") BoardType type, @Param("keyword") String keyword, Pageable pageable);
 ...
 @Query(value = """
		 ...
		 """)
 Page<BoardResponse> searchAdminPage(@Param("type") BoardType type, @Param("keyword") String keyword, Pageable pageable);
