...
public class BoardReplyResponse {
  ...
  * JPQL DTO 조회용 생성자
  */
 public BoardReplyResponse(Integer boardId, Integer parentBoardId, BoardType type, String title, String content, String memberId, LocalDateTime createdAt, LocalDateTime updatedAt) {
 ...
 public static BoardReplyResponse from(Board board) {
  ...
  response.parentBoardId = (board.getParent() != null) ? board.getParent().getBoardId() : null;
