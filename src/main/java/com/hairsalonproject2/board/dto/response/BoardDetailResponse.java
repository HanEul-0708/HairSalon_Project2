...
public class BoardDetailResponse {
 ...
 public BoardDetailResponse(Integer boardId, BoardType type, String title, String content, String memberId, Integer viewCount, Integer parentBoardId, LocalDateTime createdAt, LocalDateTime updatedAt, boolean hidden, String hiddenReason, Integer reportCount) {
  this();
 ...
 public static BoardDetailResponse from(Board board) {
  return new BoardDetailResponse(board.getBoardId(), board.getType(), board.getTitle(), board.getContent(), board.getMember().getMemberId(), board.getViewCount(), board.getParent() != null ? board.getParent().getBoardId() : null, board.getCreatedAt(), board.getUpdatedAt(), board.isHidden(), board.getHiddenReason(), board.getReportCount());
 }
 ...
 public static class FileInfo {
  ...
  public boolean isImage() {
   return fileExtension != null && IMAGE_EXTENSIONS.contains(fileExtension.toLowerCase(Locale.ROOT));
  }
 }
}
