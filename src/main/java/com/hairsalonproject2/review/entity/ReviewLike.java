...
@Getter
@Entity
@Table(name = "review_like", uniqueConstraints = {@UniqueConstraint(name = "uk_review_like_review_member", columnNames = {"review_id", "member_id"}), @UniqueConstraint(name = "uk_review_like_review_visitor", columnNames = {"review_id", "visitor_token"})})
